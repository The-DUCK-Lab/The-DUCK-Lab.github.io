  ...
  <div class="container">
    <div class="hero-grid">
      <div class="hero-body">
        ...
        <p class="lede">
          The DUCK Lab is a neurosymbolic AI research group at Imperial College London. Our goal is to build systems that don't compromise between being <em>powerful</em> and being <em>safe</em>: we want them to not only learn from data but also reason over it, acknowledge what they don't know, respect the rules of the world, and draw on structured knowledge.
        </p>
